...
"""
    ...
    The input file(s) should be tab-delimited and have these columns (no
    header):
...
for infile in args.infiles:
    with open(infile, 'rt') as ih:
        ...
        for i, row in enumerate(rdr):
            ...
            ## Store information
            hits[gid].append((s, e, pid, n, gid, infile))
        ...
        for s, e, i, sn, g, f in hit_info:
            ...
            if closest is not None:
                try:
                    ...
                    annot = ''
            oh.write('\t'.join(str(x) for x in [f, sn, g, i, ';'.join(annot)]) + '\n')
